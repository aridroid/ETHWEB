...
export class CarServiveService {
  ...
  signup(formValue: any) {
    ...
    return this.http.post('http://localhost/ETH/api-call/signup.php', signUpData).pipe(take(1));
  }
  ...
  login(formValue: any) {
    ...
    console.log(signUpData);
    return this.http.post('http://localhost/ETH/api-call/login.php', signUpData).pipe(take(1));
  }
